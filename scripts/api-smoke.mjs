...
await check("mutasi settings tanpa login ditolak","/api/settings",401,{method:"PUT",headers:{"content-type":"application/json"},body:JSON.stringify({schoolName:"Tidak boleh"})});
await check("mutasi siswa tanpa login ditolak","/api/students",401,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({classId:1,name:"Tidak boleh"})});
